...
public class TestData {
    ...
    public static final Resume R1 = new Resume(UUID_1, "Denis");
    public static final String UUID_2 = UUID.randomUUID().toString();
    public static final Resume R2 = new Resume(UUID_2, "Candy");
    public static final String UUID_3 = UUID.randomUUID().toString();
    public static final Resume R3 = new Resume(UUID_3, "Betty");
    public static final String UUID_4 = UUID.randomUUID().toString();
    public static final Resume R4 = new Resume(UUID_4, "Anna");
    ...
    static {
        ...
        R4.setSection(SectionType.ACHIEVEMENT, new ListSection("Achivment2", "Achivment3", "Achivment4"));
    }
}
